 ...
 */
final class Version20230526093557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT AUTO_INCREMENT NOT NULL, time VARCHAR(255) NOT NULL, date DATE NOT NULL, location VARCHAR(255) NOT NULL, maxpersons INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
